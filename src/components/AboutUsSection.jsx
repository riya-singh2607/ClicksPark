        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          >
            <div className="relative">
              <div className="w-60 h-60 bg-yellow-100 rounded-full flex items-center justify-center shadow-md">
                <svg
              ...
              <div className="absolute -top-3 -left-3 w-8 h-8 bg-yellow-400 rounded-full opacity-30"></div>
              <div className="absolute bottom-0 right-0 w-6 h-6 bg-yellow-400 rounded-full opacity-30"></div>
            </div>
          </motion.div>
          <div className="text-center md:text-left">
            <motion.div variants={itemVariants} className="relative inline-block mb-3">
              ...
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 bg-yellow-400 rounded-full w-16" />
            </motion.div>
            <motion.div variants={containerVariants} className="space-y-3 max-w-xl mx-auto md:mx-0">
